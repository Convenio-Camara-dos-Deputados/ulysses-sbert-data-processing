...
def main(args) -> None:
    ...
    dfs.append(dataset_builder.utils.gen_dataframe(pairs, source_name="news_min_mpm"))
    ...
    dfs.append(dataset_builder.utils.gen_dataframe(pairs, source_name="news_min_mpt"))
    ...
    for tag, (pairs_a, pairs_b) in pairs_dict.items():
        dfs.append(dataset_builder.utils.gen_dataframe(pairs_a, source_name=f"leg_bills_art_{tag}", allow_empty=args.debug))
